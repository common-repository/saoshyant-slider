            ...
            controls: function () {
                if (settings.controls) {
                   ...
                   // $el.after('<div class="lSAction"><a class="lSPrev">' + settings.prevHtml + '</a><a class="lSNext">' + settings.nextHtml + '</a></div>');
                    ...
                    $slide.parents("[class*='sao-el']").find("[class*='arrow-next'],[class*='lSNext']").on('click', function (e) {
                        if (e.preventDefault) {
                            e.preventDefault();
					...
					$slide.parents("[class*='sao-el']").find("[class*='arrow-prev'],[class*='lSPrev']").on('click', function (e) {
                        if (e.preventDefault) {
                            e.preventDefault();
            ...
            initialStyle: function () {
				...
				if (settings.loop === false){
 				 if($el.parent().parent().find('.lSPager').find('li:first-child').hasClass('active')){
					$el.parent().parent().parent().addClass('sao-hide-prev');
				 }else{
					$el.parent().parent().parent().removeClass('sao-hide-prev');
				 }
				if($el.parent().parent().find('.lSPager').find('li:last-child').hasClass('active')){
					$el.parent().parent().parent().addClass('sao-hide-next');
				}else{
					$el.parent().parent().parent().removeClass('sao-hide-next');
				 }
            ...
            move: function (ob, v) {
				...
				if (settings.loop === false){
 				 if($slide.parent().find('.lSPager').find('li:first-child').hasClass('active')){
					$slide.parent().parent().addClass('sao-hide-prev');
				 }else{
					$slide.parent().parent().removeClass('sao-hide-prev');
				 }
				if($slide.parent().find('.lSPager').find('li:last-child').hasClass('active')){
					$slide.parent().parent().addClass('sao-hide-next');
				}else{
					$slide.parent().parent().removeClass('sao-hide-next');
				 }
