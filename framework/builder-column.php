...
******************************************************************************************************************************************************
															 	...
															 	sao_slider_builder_column
 
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if ( !function_exists ( "sao_slider_builder_column" )){
function sao_slider_builder_column(){
	...
	echo '<li id="sao_column_1" class="sao_column_item sao_builder_column_item   sao_row_item"  data-key="1" data-value="main"  data-child="1">';
			...
			echo '<div class="sao_row_bottom">';
				echo '<a class="sao_add_element sao_add_row"><i></i>'.esc_html__('Add New Element','saoshyant-slider').'</a>';
				echo '<a class="sao_element_template_add sao_template_add"  data-row="slider_element" data-name="'.esc_html__('Slider Element','saoshyant-slider').'"></a>';
			echo '</div>';
