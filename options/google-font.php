<?php
function sao_slider_font_url($text_font_family =false) {
    $font_url = '';
     if(!empty($text_font_family)) {
        $frozen_body_font_get_family = $text_font_family;
    } else {
        $frozen_body_font_get_family = 'Roboto';
    }
 
	$font_url = add_query_arg( 'family', urlencode( ''.$frozen_body_font_get_family.':300,300i,400,400i,700,700i,900,900i&subset=latin,latin-ext' ), "https://fonts.googleapis.com/css" );
  
    return $font_url;
} 
 

function sao_goooglefont() {
return array(
'' =>'',
'ABeeZee' =>'ABeeZee',
'Abel' =>'Abel',
